...
public class Test {
 public static void main(String []args) {
	 ...
	 try {
		tesseract.setDatapath("D:/javaprojects/SimpleTesseract/src/main/resources");
		...
		String text = tesseract.doOCR(new File("D:/javaprojects/SimpleTesseract/src/main/resources/test.png"));
